...
public class JSGDecorPlacement {
    ...
    public static ResourceKey<PlacedFeature> placed(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(JSGDecor.MOD_ID, name));
    }

    public static ResourceKey<BiomeModifier> biomeModifier(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(JSGDecor.MOD_ID, name));
    }
}
